...
puts "MY FAVORITE WORD IS #{love.upcase}"
...
puts "There are #{34} in #{big_word.length}"
...
puts "There are now #{new_letter_count} in #{bigger_word.size}"
